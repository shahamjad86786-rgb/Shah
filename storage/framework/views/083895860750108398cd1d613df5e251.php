...
<div class="page-heading">
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                ...
                <p class="text-subtitle text-muted"><?php echo e(isset($data) ? 'Update the tenant with all required details.' : 'Add a new tenant to the system with all required details.'); ?></p>
            </div>
    ...
    <section class="section">
      ...
      action="<?php echo e(isset($data) ? route('admin.client.update', $data->id) : route('admin.client.store')); ?>"
    ...
    <div class="row g-4">
        ...
        <?php if(session('any_error')): ?>
            <?php $__currentLoopData = session('any_error'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="col-lg-2">
            <div class="card shadow-sm border-0 rounded-4 text-center">
                ...
                <img id="profilePreview"
                     src="<?php echo e(isset($data) && $data->profilePicture()->url ? $data->profilePicture()->url : $default); ?>"
                     class="img-fluid">
        ...
        <div class="col-lg-2">
            <div class="card shadow-sm border-0 rounded-4 text-center">
                ...
                <img id="signaturePreview"
                     src="<?php echo e(isset($data) && $data->signature ? Storage::url($data->signature) : $default); ?>"
                     class="img-fluid">
        ...
        <div class="col-lg-2">
            <div class="card shadow-sm border-0 rounded-4 text-center">
                ...
                <img id="aadharFrontPreview"
                     src="<?php echo e(isset($data) && $data->aadhar_front ? Storage::url($data->aadhar_front) : $default); ?>"
                     class="img-fluid">
        ...
        <div class="col-lg-2">
            <div class="card shadow-sm border-0 rounded-4 text-center">
                ...
                <img id="aadharBackPreview"
                     src="<?php echo e(isset($data) && $data->aadhar_back ? Storage::url($data->aadhar_back) : $default); ?>"
                     class="img-fluid">
        ...
        <div class="col-lg-2">
            <div class="card shadow-sm border-0 rounded-4 text-center">
                ...
                <img id="panCardPreview"
                     src="<?php echo e(isset($data) && $data->pan_card ? Storage::url($data->pan_card) : $default); ?>"
                     class="img-fluid">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('componet.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\shah\resources\views/client/edit.blade.php ENDPATH**/ ?>